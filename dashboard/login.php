                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="uname" type="text" name="Email" placeholder="enter your username" required />
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label class="text-dark" for="pwd">Mật khẩu</label>
                                        <input class="form-control" id="pwd" type="password" name="MatKhau" placeholder="enter your password" required />
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12 text-center mt-5">
                                    Chưa có tài khoản? <a href="register.html" class="text-danger">Đăng Ký</a>
                                </div>
                            </div>
                        </form>
                    </div>
