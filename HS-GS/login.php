                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="uname" type="text" name="Email" placeholder="enter your username" />
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label class="text-dark" for="pwd">Mật khẩu</label>
                                        <input class="form-control" id="pwd" type="password" name="MatKhau" placeholder="enter your password" />
                                    </div>
                                </div>
